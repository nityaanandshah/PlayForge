...
const mockTournaments: any[] = [
      ...
      rounds: [
        {
          ...
          matches: [
            ...
            {
              match_id: 'match-1-1-2',
              round: 1,
              match_number: 2,
              player1_id: 'user-charlie',
  ...
  },
  {
    ...
    is_private: false,
    participants: [
      { user_id: 'user-alice', username: 'alice', status: 'eliminated' },
